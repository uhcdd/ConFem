...
#        self.ConFem_ = ConFem.ConFem()
    ...
    def testE3_02C1(self):
        ...
        self.assertEqual(self.ConFem1.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'c5ed5fc0064ac2e283dd2f04664dc7d9')
    def testE3_02C2(self):
        ...
        self.assertEqual(self.ConFem2.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '693ba44f767166abaa5b16de2cf4de0e')
    def testE3_02C3(self):
        ...
        self.assertEqual(self.ConFem3.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'ed9402914f00e0a396bc0e2484f1af0a')
    def testE3_04(self):
        self.ConFem4 = ConFem.ConFem()
        Name="../DataExamples/E03/E3-04"                 # ConFem Simple reinforced concrete tension bar
        self.assertEqual(self.ConFem4.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '81f1bdd92c7203431800ba2e23aedbfa')
        """
        beams
        """
    def testE4_02(self):
        ...
        self.assertEqual(self.ConFem5.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '2554e3af22311af866090970a535fa6a')
    def testE4_03(self):
        self.ConFem6 = ConFem.ConFem()
        Name="../DataExamples/E04/E4-03"                 # Confem Creep deformations of reinforced concrete beam 
        self.assertEqual(self.ConFem6.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '9e4a27be6fc2ec4ec296e9b3e6f0ccb2')
    def testE4_04(self):
        self.ConFem7 = ConFem.ConFem()
        Name="../DataExamples/E04/E4-04"                 # ConFem Temperature actions on reinforced concrete beam
        self.assertEqual(self.ConFem7.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False, "elemout", [], False), '14919558a817061a1a7967085f817067')
    def testE4_06(self):
        self.ConFem8 = ConFem.ConFem()
        Name="../DataExamples/E04/E4-06"                 # ConFem Prestressed reinforced concrete beam
        self.assertEqual(self.ConFem8.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '698134caac0963a0a821880be492d06c')
    def testE4_08(self):
        self.ConFem8 = ConFem.ConFem()
        Name="../DataExamples/E04/E4-08"                 # ConFem Cantilever column 2nd order
        self.assertEqual(ConFem.ConFem().Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'e487212a2819cf9718ef5478520d7525')
    def testE4_09(self):
        self.ConFem9 = ConFem.ConFem()
        Name="../DataExamples/E04/E4-09"                 # ConFem Reinforced concrete beam under impact load
        self.assertEqual(self.ConFem9.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '58ac4c4c2b5e47da07d7d3172f721c6f')
    def testE4_10(self):
        self.ConFem10 = ConFem.ConFem()
        Name="../DataExamples/E04/E3-02_CircMises"                 # ConFem circ cross section with mises plasticity
        self.assertEqual(self.ConFem10.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '286166846a1f62789d2c1d86dd870b38')
        """
        plate / strut-and-tie
        """
    def testE5_01plate(self):
        ...
        self.assertEqual(self.ConFem10.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'ff12989226a1a873f0eeda2c38a6d9b7')
    def testE5_01(self):
        Name="../DataExamples/E05/E5-02"                 # ConFem Deep Beam as strut and tie model nonlinear arc length
        self.assertEqual(ConFem.ConFem().Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False, "elemout", [], False),'f084961ab296a5696882dfb4bb0e3e44')
    ...
    def testE5_02u03(self):
        ...
        self.assertEqual(self.ConFem12.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '7cefcf64d60beb9741d6e7203bc2066c')
        """
        plates
        """
    def testE8_00(self):
    ...
    def testE9_04(self):
        ...
        self.assertEqual(self.ConFem13.Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), '6fc9671a48335d85c1cc21114ee56132')
        """
        shells
        """
    def testE10_02a(self):
        Name="../DataExamples/E10/E10-02a"                # ConFem Slab as RC shell            
        self.assertEqual(ConFem.ConFem().Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'c38dc136dd7e2ce9509a635e339f3d44')
        """
        bond
        """
    def testBond_0(self):
    ...
    def testSpec_0(self):
        ...
        self.assertEqual(ConFem.ConFem().Run(Name, self.LogData,self.NameLog, False, LinAlgFlag, False,"elemout", [], False), 'eb43d6286e371efa17b92c3f84e9623c')
