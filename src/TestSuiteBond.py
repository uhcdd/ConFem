...
#        self.ConFem_ = ConFem.ConFem()
    ...
    def testBond_1(self):
        ...
        self.assertEqual(ConFem.ConFem().Run(Name, self.NameLog, False, LinAlgFlag, False,"elemout", None, None, [], False), '8fdf324fa646d9b2af0ad249c2b3409c')
    def testBond_2(self):
        Name="../_DataC3D/Cube8"                            # C3D8, T3D3 fibers in 3D block
        self.assertEqual(ConFem.ConFem().Run(Name, self.NameLog, False, LinAlgFlag, False,"elemout", None, None, [], False), '4ed9a592900a0554aab50b79ca06c57d')
    def testBond_3(self):
        Name="../DataExamples/E08/E8-03B23E"               # CPS4, B23E single fiber connecting a dissected continuum
        self.assertEqual(ConFem.ConFem().Run(Name, self.NameLog, False, LinAlgFlag, False,"elemout", None, None, [], False), '6d0e8f63a4faaf0cdcd1927423f5e28f')
    def testBond_4(self):
        Name="../_DataBond/PulloutAxiSym"                  # CAX4, TAX2
        self.assertEqual(ConFem.ConFem().Run(Name, self.NameLog, False, LinAlgFlag, False,"elemout", None, None, [], False), 'b447294da04587b11961753e1a996922')
