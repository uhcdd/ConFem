...
@author: josh
'''
from ConFemBasics import ZeroD
...
#             RandomField_Routines.property[elset].append((label,prop))
    ...
    def get_property(self,elset,label,original):
        '''Problem: aktuelle Eigenschaft des Materials wird bei Aufruf ueberschrieben 
        und wird fuer weitere Verwendung nicht zwischengespeichert'''
        try:
