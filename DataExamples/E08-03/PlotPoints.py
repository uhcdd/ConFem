...
P3, p3 = DefPlot("P_u")
Plot0(p3,'E6-03.timeout - Kopie.txt','steelblue')
Plot0(p3,'E6-03.timeout - Kopie (2).txt','forestgreen')
Plot0(p3,'E6-03.timeout - Kopie (3).txt','darkorange')
#Plot0(p3,'E6-03.timeout.txt','magenta')
P3.autofmt_xdate()
plt.show()
